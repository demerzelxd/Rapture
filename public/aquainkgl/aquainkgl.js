...
var canvas = document.querySelector('[data-aquainkgl-canvas]') || document.getElementsByTagName('canvas')[0];
resizeCanvas();
...
var ditheringTexture = createTextureAsync('/aquainkgl/LDR_LLL1_0.png');
...
canvas.addEventListener('mousedown', function (e) {
    var pos = getCanvasPointerPosition(e);
    if (pos == null) { return; }
