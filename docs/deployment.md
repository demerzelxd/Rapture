...
目前没有设置 Content Security Policy。站点使用了 Astro inline scripts、Google Fonts、远程图片和 AquaInkGL WebGL 效果；仓促添加 CSP 很容易过严并破坏视觉体验。之后如果要加 CSP，应先覆盖测试首页、相册查看器、远程图片源、Archive 电缆动效和全站命令面板。
